...
\begin{enumerate}
    ...
    \item \textbf{Political \& Legal Philosophy}: How do Hohfeldian jural relations provide the deontic structure formalized in the $V_4$ gauge group?
\end{enumerate}
...
The Epistemic Invariance Principle is, at its core, a statement about group actions. The ``meaning-preserving transformations'' of EIP form a group; EIP demands that the judgment function be invariant under this group's action on the input space. The Bond Invariance Principle further identifies a deontic symmetry group governing the gauge structure of normative evaluation: the measured $V_4 \times U(1)_\calH$, inside a posited $D_4 \times U(1)_\calH$.
...
\begin{definition}[Deontic Gauge Group]
The measured deontic symmetry group is the Klein four-group $V_4$, generated by the correlative swap and jural negation acting on the four Hohfeldian jural relations---rights, duties, liberties, and no-rights.  The dihedral group $D_4$ (symmetries of the square) is posited as an ambient group, licensed only if quarter-turn operations are independently demonstrated as normative operations.  The full gauge group of geometric ethics is the measured $V_4 \times U(1)_\calH$, inside a posited $D_4 \times U(1)_\calH$, where $U(1)_\calH$ is the harm phase group governing conservation.
\end{definition}

\begin{theorem}[Deontic Gauge Group Theorem, informal]
The measured symmetry group of the deontic structure of bilateral legal/moral relations is the Klein four-group $V_4$, generated by the Hohfeldian correlative and negation operations.  These two operations are commuting involutions, so they generate $V_4$, not $D_4$; the full $D_4$ remains a posited extension.
\end{theorem}
...
Hohfeld's analytical framework for jural relations provides the deontic structure formalized in the $V_4$ gauge group. Rawls's theory of justice, social contract theory, and theories of legitimate authority provide the normative content of the ``governance'' dimension of the moral manifold.
...
These four relations, together with the \emph{correlative} operation (switching perspectives between right-holder and duty-bearer) and the \emph{negation} operation (right $\leftrightarrow$ no-right, duty $\leftrightarrow$ liberty), generate the Klein four-group $V_4$: the two operations are commuting involutions, and their composition is the $180^\circ$ rotation of the Hohfeldian square, never a quarter-turn. This is the origin of the measured $V_4$ gauge symmetry in Geometric Ethics; the full dihedral group $D_4$ is posited as an ambient group but would require quarter-turn operations to be independently demonstrated as normative operations.
